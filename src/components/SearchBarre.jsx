    ...
    return (
        <form onSubmit={handleSubmit} className="flex items-center justify-center">
            ...
            <input
                ...
                onChange={onChange}
                name="searching"
                className="border border-gray-300 rounded px-2 py-1 focus:outline-none focus:border-blue-600"
            />
            <button type="submit" className="ml-2 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-600">Lancer la recherche</button>
        </form>
    );
};
